...
public class ChatActivity extends AppCompatActivity
{
      ...
      //  Toast.makeText(ChatActivity.this, messageReceiverName, Toast.LENGTH_SHORT).show();
        ...
        rootRef.child("Users").child(messageReceiverId).addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                Picasso.with(ChatActivity.this).load(userThumb).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.default_profile).into(userChatProfileImage, new Callback()
                {
                    @Override
                ...
                else
                {
                   // userLastSeen.setText(online);
                    ...
                    String lastSeenDysplayTime = getTime.getTimeAgo(last_seen, getApplicationContext());

                    userLastSeen.setText(lastSeenDysplayTime);
                }
            }
    ...
    private void FetchMessages()
    {
        ...
        messageQuery.addChildEventListener(new ChildEventListener()
        {
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s)
            {
               // Messages messages = dataSnapshot.getValue(Messages.class); tu sam pogresio trebalo u on ChildAdded
              //  messageList.add(messages);
               // messageAdapter.notifyDataSetChanged();
            }
